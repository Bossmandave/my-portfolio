            ...
            <div className="pt-20">
                ...
                <div className="relative my-[50px] pt-[50px]">
                    ...
                    <div className="relative text-right w-1/2 pr-9 pl-12 mb-10 max-[769px]:text-left max-[769px]:pl-[100px]  max-[769px]:w-full max-[586px]:pl-[50px]">
                        ...
                        <p className="font-medium text-gray-500 text-[17px] mt-2 max-[769px]:w-[90%] max-[586px]:text-[16px]">During my internship at Baun Robotics, I had the opportunity to work on cutting-edge robotics projects, collaborating with a dynamic team of engineers and developers.</p>
                    ...
                    <div className="relative text-left w-1/2 ml-[50%] pr-9 pl-12 mb-10 max-[769px]:ml-[80px] max-[769px]:pl-6 max-[769px]:w-[90%] max-[586px]:ml-[28px]">
                        ...
                        <p className="font-medium text-gray-500 text-[17px] mt-2 max-[769px]:w-[90%] max-[586px]:text-[16px]">I gained comprehensive experience in various aspects of ICT, including system administration, network management, and technical support. This role allowed me to develop a broad skill set and contribute to the efficient operation of the company’s IT infrastructure.</p>
                    ...
                    <div className="relative text-right w-1/2 pr-9 pl-12 mb-10 max-[769px]:text-left max-[769px]:pl-[100px]  max-[769px]:w-full max-[586px]:pl-[50px]">
                        ...
                        <p className="font-medium text-gray-500 text-[17px] mt-2 max-[769px]:w-[90%] max-[586px]:text-[16px] "> I gained hands-on experience in building and enhancing user interfaces for web applications. I worked closely with a team of developers and designers to create engaging, responsive, and accessible web experiences.</p>
                        <div className="absolute top-2 -right-[8px] w-[16px] h-[16px] border-4 border-blue-600 rounded-full max-[769px]:left-[72px] max-[586px]:left-[20px]"></div>
                    </div>
