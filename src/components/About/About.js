            ...
            <div className="about-wrapper pt-36 pb-16">
                <div className="pl-[100px] max-[1024px]:pl-[20px]">
                    ...
                    <p className="text-gray-500 text-[17px] w-[90%] font-medium max-[769px]:text-[16px] max-[769px]:w-[90%]">
                        With expertise in HTML, CSS, JavaScript, Git and front-end frameworks like React JS and Tailwind CSS, I bring your digital ideas to life. I can tailor solutions to meet your specific needs. From custom animations to seamless user experiences, I ensure that every project is not only aesthetically pleasing but also highly functional. Let's collaborate and bring your vision to the digital world.</p>
                </div>
                ...
                <div className="px-20 max-[1024px]:px-[20px] relative">
                    ...
                    <p className="text-gray-500 text-[17px] font-medium max-[769px]:text-[16px] max-[769px]:w-[90%]">I thrive in environments that challenge me to push the boundaries of what's possible on the web. Whether it's building intricate user interfaces, optimizing web performance, or ensuring cross-browser compatibility, I am dedicated to delivering top-notch solutions.</p>
